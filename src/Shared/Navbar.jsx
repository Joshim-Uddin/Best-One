...
const Navbar = () => {
    ...
    return (
        ...
        <nav className={colorChange?'flex md:flex-row flex-col absolute z-50 bg-red-950 justify-between px-10 items-center py-8 uppercase md:sticky md:top-0':'flex md:flex-row flex-col justify-between px-10 items-center py-8 z-99 uppercase md:sticky md:top-0'}>
